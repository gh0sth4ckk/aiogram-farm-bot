...
async def garden(message: types.Message) -> None:
    ...
    await message.answer("\n".join([
        ...
        [InlineKeyboardButton(text="✂️ Добыть шерсть", callback_data=sheep_callback.new("get")), InlineKeyboardButton(text="🤚 Собрать шерсть", callback_data=sheep_callback.new("cath"))]
    ]))
